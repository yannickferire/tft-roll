    ...
    <footer className="bg-earlynight py-4 rounded">
      <div className="flex flex-col sm:flex-row px-4">
        ...
        <p className="order-1 sm:order-2 flex-1 text-center sm:text-right text-xs text-crema leading-5">
          ...
          <span className="opacity-40">Made by</span> <a className="leading-[30px] sm:leading-normal font-bold opacity-40 hover:opacity-100" href="https://lolchess.gg/profile/euw/krksyx" target="_blank" rel="noreferrer">krksyx</a><span className="inline opacity-40"> – © 2023 TFT Odds</span></p>
      </div>
    </footer>
  )
}
