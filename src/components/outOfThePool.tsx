...
const OutOfThePool: React.FC<IOutOfThePool> = ({ champion,sameCostCopies, setSameCostCopies, pool }) => {
  ...
  return (
    <div className="inline-block w-full bg-crema rounded">
      <h4 className="text-sm mb-2 leading-tight"><strong className={`text-${champion.cost}cost font-medium`}>{champion.cost} cost</strong> out of the pool <small className="block opacity-60">(approximatively)</small></h4>
